...
export const project = {
  ...
  assetVersion: "20260521-beyond-global-village-launch-3",
  ...
  seo: {
    title: "BEYOND Dubailand Apartments | Oaklyn Realty",
    description:
  ...
  hero: {
    ...
    title: "BEYOND's first master community in Dubailand",
    subtitle:
      "Set next to Global Village, these luxury 1 to 3 bedroom apartments in Dubailand offer a greener, lower-rise setting, a flexible payment plan, 10% booking, and launch pricing from AED 1.4M, subject to developer confirmation.",
  ...
  about: {
    eyebrow: "About The Launch",
    title: "A calmer apartment address in Dubailand",
    text:
      "This launch is positioned as the first master community by BEYOND in Dubailand, with luxury apartments set around landscaped courtyards, water features, and calmer shared spaces near Global Village. Pricing, unit mix, payment structure, and final amenity scope should always be re-confirmed against the latest release."
  },
  residences: {
    eyebrow: "Residences",
    title: "Luxury apartments for different buying goals",
    text:
      "The release focuses on 1 to 3 bedroom apartments, giving end users and investors a straightforward range to compare at launch.",
    items: [
      {
        title: "1 Bedroom Apartments",
        text: "A practical entry point for buyers who want the BEYOND community story, a premium address, and a lower capital starting level."
      },
      {
        title: "2 Bedroom Apartments",
        text: "Balanced layouts for couples, small families, and buyers who want more flexibility for personal use or rental positioning."
      },
      {
        title: "3 Bedroom Apartments",
        text: "Larger homes for buyers prioritising space, hosting, and a more established long-term living setup."
      }
    ]
  },
  paymentPlan: {
    eyebrow: "Payment Plan",
    title: "Flexible launch terms with 10% on booking",
    text:
      "The current launch brief indicates a 10% booking amount with the balance structured across a flexible payment plan. Exact milestone dates, handover timing, and fee breakdowns remain subject to the latest developer release.",
    steps: [
      {
        label: "Reserve",
        value: "10% on booking",
  ...
  gallery: {
    ...
    title: "Warm architecture and landscaped courtyards",
    text:
      "The visual set now shows the project from wider masterplan angles through to closer architectural details, helping buyers read both the overall community mood and the finer design language.",
    items: [
      {
  ...
  snapshot: {
    ...
    title: "What the community is designed around",
    text: "",
    items: [
      {
  ...
  faq: [
    ...
    {
      question: "Does Oaklyn Realty guarantee returns or appreciation?",
      answer: "No. Oaklyn Realty does not guarantee ROI, rental income, capital appreciation, or resale profit."
    }
  ],
  trustPoints: [
    {
      title: "Current launch guidance",
      text: "We help you review the latest price list, release notes, and availability rather than relying on outdated ads."
    },
    {
      title: "Clear consultant follow-up",
      text: "Your enquiry is handled by Oaklyn Realty so you can compare apartment types, booking requirements, and next steps quickly."
    },
    {
      title: "Compliant communication",
      text: "We do not promise ROI, future price growth, visa approval, or other outcomes that depend on market conditions or third-party decisions."
    }
  ],
  form: {
    title: "Request BEYOND Launch Details",
    text:
      "Share your enquiry and Oaklyn Realty will send the current price list, apartment options, booking details, and the latest payment-plan guidance for this launch.",
    splitName: false,
    labels: {
      name: "Full Name",
      phone: "Phone Number",
      email: "Email Address",
      project: "Property Type of Interest",
