...
export const project = {
  ...
  assetVersion: "20260522-master-community-live-url-1",
  ...
  hero: {
    ...
    subtitle:
      "Next to Global Village, this upcoming BEYOND launch introduces 1 to 3 bedroom apartments in a greener low-rise setting, from AED 1.1M with 10% booking and a 60/40 payment plan, subject to developer confirmation.",
  ...
  form: {
    title: "Share your contact details and project requirements",
    text:
      "Please provide the basic details needed for follow-up: first name, last name, phone number with country code, a valid email address, how many bedrooms you need, your project requirements, and any comments.",
    splitName: true,
    labels: {
      name: "Full Name",
