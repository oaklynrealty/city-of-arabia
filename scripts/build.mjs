...
${renderNav()}
  <main>
    ...
    <section class="section location-section${project.location.image ? " has-location-image" : ""}" id="location">
      ${project.location.image ? `<div class="location-section-bg" style="background-image: url('${escapeHtml(withAssetVersion(project.location.image))}');" aria-hidden="true"></div>` : ""}
