            ...
            <div class="field-grid">
              ...
              <div class="field is-phone" id="phoneField">
                ...
                <div class="phone-input-row">
                  ...
                  <input id="landing_phone" name="phone" type="tel" inputmode="numeric" autocomplete="off" autocorrect="off" spellcheck="false" pattern="[0-9]{6,12}" maxlength="12" placeholder="58 583 5230" required>
                </div>
                <div class="field-error">Please enter a valid phone number using 6 to 12 digits.</div>
              </div>
